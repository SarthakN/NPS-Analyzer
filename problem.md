...
Product and customer success teams collect Net Promoter Score (NPS) feedback through surveys, but raw CSV exports are difficult to interpret and act on. Without proper tooling, teams struggle to:
...
- **Product managers** — Need to prioritize features based on what detractors and passives say
- **Customer success teams** — Want to identify at-risk accounts and regional hotspots
- **Leadership** — Require clear dashboards and metrics to track NPS over time

## Success Criteria

A solution should:

- Ingest standard NPS CSV exports with minimal configuration
